...
export interface AccountRecoveryResetPasswordOAuthIntegration {
  ...
  data: {
    ...
    email: OAuthIntegrationData['email'];
    emailToHashWith: OAuthIntegrationData['emailToHashWith'];
    code: OAuthIntegrationData['code'];
    token: OAuthIntegrationData['token'];
  };
...
export interface AccountRecoveryResetPasswordBaseIntegration {
  ...
  data: {
    ...
    email: BaseIntegrationData['email'];
    emailToHashWith: BaseIntegrationData['emailToHashWith'];
    code: BaseIntegrationData['code'];
    token: BaseIntegrationData['token'];
  };
}
