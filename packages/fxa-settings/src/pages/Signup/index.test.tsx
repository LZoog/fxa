...
describe('Signup page', () => {
  ...
  it('renders third party auth when service=relay and supportsPasswordlessLogin is true', async () => {
    await act(() => {
      renderWithLocalizationProvider(
        <Subject
          integration={createMockSignupOAuthNativeIntegration(
  ...
  it('renders third party auth when service=aimode and supportsPasswordlessLogin is true', async () => {
    await act(() => {
      renderWithLocalizationProvider(
        <Subject
