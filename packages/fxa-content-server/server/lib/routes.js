...
module.exports = function (config, i18n, statsd) {
  ...
  const reactRouteGroups = getReactRouteGroups(config.showReactApp);
  ...
  const routes = [
    ...
    require('./routes/get-frontend-pairing')(reactRouteGroups),
    require('./routes/get-frontend')(reactRouteGroups),
    require('./routes/get-oauth-success')(reactRouteGroups),
