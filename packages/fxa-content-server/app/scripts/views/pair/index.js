...
export const GLEAN_EVENT_REASON_HAS_MOBILE = 'has mobile';
export const GLEAN_EVENT_REASON_NO_MOBILE = 'does not have mobile';
...
class PairIndexView extends FormView {
  ...
  events = {
    ...
    'click .input-radio-wrapper': 'handleRadioEngage',
  };
