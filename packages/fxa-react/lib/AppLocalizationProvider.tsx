 ...
 * @param reportBundleError Receives whole-bundle load failures. Each one is
 * recoverable — Fluent falls back to the English defaults in the JSX — so
 * without a reporter a total localization outage produces no signal at all.
 * @returns
 */
